        ...
        public:
          ...
          ALPAKA_FN_ACC void operator()(TAcc const& acc,
            ...
            while (current_tower_block < trailer && iCh < numbChannels) {
              ...
              for (uint32_t ich = 0; ich < nchannels; ich += alpaka::getWorkDiv<alpaka::Block, alpaka::Threads>(acc)[0u]) {
                auto const i_to_access = ich + alpaka::getIdx<alpaka::Block, alpaka::Threads>(acc)[0u];
